/* iOS config.h for iPerf3 */

#ifndef CONFIG_H
#define CONFIG_H

/* Include standard types for iOS */
#include <stdint.h>
#include <sys/types.h>
...
/* iOS/macOS does not support TCP_CONGESTION */
...
/* TCP_USER_TIMEOUT is Linux-only (Linux 2.6.37+), not available on iOS/macOS */
...
/* iOS/macOS atomic types handling */
#ifdef __has_include
