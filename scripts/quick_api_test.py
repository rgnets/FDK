#!/usr/bin/env python3
"""
Quick Python script to test the API and see what fields are present
Run this with: python3 scripts/quick_api_test.py
"""
...
def main():
    ...
    if not ap_result['has_pms_room_id'] and not mc_result['has_pms_room_id']:
        ...
        print("1. Use device name patterns as primary method")
        print("2. Or trust that the API returns correct devices per room")
    else:
