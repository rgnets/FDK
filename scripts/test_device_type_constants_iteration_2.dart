...
/// Isolated test program for DeviceTypes constants (Iteration 2)
/// Fixed reserved keyword issue with 'switch'

import 'dart:io';

void main() async {
  print('=== Testing Device Type Constants (Iteration 2) ===');
...
Future<bool> testBasicConstants() async {
  try {
    ...
    if (MockDeviceTypes.networkSwitch != 'switch') {
      print('  ❌ networkSwitch constant wrong value');
      return false;
    }
...
/// Using networkSwitch instead of switch to avoid reserved keyword
class MockDeviceTypes {
  MockDeviceTypes._();
  
  static const String accessPoint = 'access_point';
  static const String networkSwitch = 'switch';  // Avoid reserved keyword
