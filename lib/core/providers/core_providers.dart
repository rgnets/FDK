...
final sharedPreferencesProvider = Provider<SharedPreferences>((ref) {
  throw UnimplementedError('SharedPreferences must be overridden with override');
});
...
final notificationGenerationServiceProvider = Provider<NotificationGenerationService>((ref) {
