...
class WebSocketDataSyncService {
  ...
  List<String> _extractRoomDeviceIds(Map<String, dynamic> roomData) {
    ...
    // Use raw IDs (no prefixes) to match WebSocket device IDs
    addDevices(roomData['access_points'] as List<dynamic>?);
    addDevices(roomData['media_converters'] as List<dynamic>?);
    addDevices(roomData['switch_devices'] as List<dynamic>?);
    addDevices(roomData['wlan_devices'] as List<dynamic>?);
